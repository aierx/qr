...
public class LockManager {
    ...
    public LockResult lock(String key, long expireTime, long waitTime) {
        return lock(key, expireTime, waitTime, () -> new IllegalArgumentException("a"));
    }
     ...
     * @return LockResult  加锁结果
     */
    private LockResult lock(String key, long expireTime, long waitTime, Supplier<IllegalArgumentException> exceptionSupplier) {
